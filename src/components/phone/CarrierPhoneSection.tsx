...
export default function CarrierPhoneSection({
  visible, carrier, onCarrierChange, phone, onPhoneChange, onRequestCode, disabled
}: Props) {
        ...
        <div className="relative" ref={boxRef}>
          ...
          >
            ...
            <svg width="18" height="18" viewBox="0 0 24 24"
              ...
              <path d="M7 10l5 5 5-5" stroke="#6b7280" strokeWidth="2"
              ...
              {others.map((c) => (
                <li key={c.key}>
                  <button
                    ...
                    onClick={() => { onCarrierChange(c.key); setOpen(false); }}
                  >
                    {c.label}
                  </button>
                </li>
