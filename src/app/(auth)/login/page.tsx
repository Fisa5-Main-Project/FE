      ...
      <div className="card-frame">
        ...
        <div className="p-5 flex flex-col gap-5 pb-28">
          <div className="flex flex-col gap-0 text-[20px]" style={{ color: 'var(--color-text-strong)' }}>
            <div>서비스 이용을 위해</div>
            <div><span className="font-extrabold">본인확인</span>을 해주세요.</div>
          </div>
        ...
        >
          <button
            ...
            style={{
              backgroundColor: !identityReady || !phoneReady ? '#C8C8C8' : '#4E07FF',
            }}
      ...
      {successOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center">
          ...
          <div className="relative w-full max-w-[420px] bg-white rounded-t-2xl p-6">
            ...
            <button className="btn-primary" onClick={() => setSuccessOpen(false)}>확인</button>
